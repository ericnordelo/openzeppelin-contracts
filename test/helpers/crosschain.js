...
const L1StandardBridgeOptimismMock = artifacts.require('L1StandardBridgeOptimismMock');
const L2StandardBridgeOptimismMock = artifacts.require('L2StandardBridgeOptimismMock');
...
async function deployBridge(type = 'Arbitrum-L2') {
  switch (type) {
    ...
    case 'Optimism-L1':
      return L1StandardBridgeOptimismMock.new();

    case 'Optimism-L2':
      return L2StandardBridgeOptimismMock.new();
